...
|
*/
$config['rest_realm'] = 'EMPLOPAD API';
...
|
*/
/*$config['auth_override_class_method']['auth_controller']['client_login'] = 'digest';*/
$config['auth_override_class_method']['module_controller']['modules'] = 'none';
// $config['auth_override_class_method']['deals']['insert'] = 'digest';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
...
|
*/
$config['rest_keys_table'] = 'admin_keys';
...
|
*/
$config['rest_key_name'] = 'HDI-API-KEY';

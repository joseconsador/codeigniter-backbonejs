 ...
 **************************************************************************/
	...
	$tcpdf['base_url'] = "http://".$_SERVER['HTTP_HOST'];
    $tcpdf['base_url'].= str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']).'application/third_party/tcpdf/';
 ...
 **************************************************************************/
	...
	$tcpdf['creator'] = 'HDI Core';
	$tcpdf['author'] = 'HDI System Technologies';
